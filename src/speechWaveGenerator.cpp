...
// ------------------------------------------------------------
// ANNOUNCER-STYLE Glottal Pulse with Subtle Return Phase
// ------------------------------------------------------------
// - Fast opening (power=1.3)
// - Peak at 60%  
// - Sharp closing (power=4.5)
// - SUBTLE return phase (4% dip, fast recovery)
//
// Reduced return depth to avoid "boxy" resonance.

#define REAL_GLOTTAL_LEN 518

static const float realGlottalPulse[REAL_GLOTTAL_LEN] = {
    +0.0000000f, +0.0041807f, +0.0083574f, +0.0125301f, +0.0166986f, +0.0208631f,
    +0.0250235f, +0.0291798f, +0.0333321f, +0.0374802f, +0.0416241f, +0.0457640f,
    +0.0498997f, +0.0540313f, +0.0581587f, +0.0622819f, +0.0664009f, +0.0705158f,
    +0.0746265f, +0.0787329f, +0.0828351f, +0.0869331f, +0.0910269f, +0.0951164f,
    +0.0992017f, +0.1032826f, +0.1073593f, +0.1114317f, +0.1154998f, +0.1195636f,
    +0.1236231f, +0.1276782f, +0.1317290f, +0.1357754f, +0.1398175f, +0.1438552f,
    +0.1478885f, +0.1519174f, +0.1559419f, +0.1599619f, +0.1639775f, +0.1679887f,
    +0.1719954f, +0.1759977f, +0.1799955f, +0.1839887f, +0.1879775f, +0.1919618f,
    +0.1959415f, +0.1999167f, +0.2038873f, +0.2078534f, +0.2118149f, +0.2157718f,
    +0.2197241f, +0.2236718f, +0.2276148f, +0.2315532f, +0.2354870f, +0.2394161f,
    +0.2433405f, +0.2472602f, +0.2511753f, +0.2550856f, +0.2589912f, +0.2628920f,
    +0.2667881f, +0.2706794f, +0.2745659f, +0.2784476f, +0.2823245f, +0.2861966f,
    +0.2900638f, +0.2939262f, +0.2977837f, +0.3016363f, +0.3054841f, +0.3093269f,
    +0.3131648f, +0.3169977f, +0.3208257f, +0.3246487f, +0.3284668f, +0.3322798f,
    +0.3360878f, +0.3398908f, +0.3436887f, +0.3474816f, +0.3512693f, +0.3550520f,
    +0.3588296f, +0.3626020f, +0.3663693f, +0.3701314f, +0.3738884f, +0.3776402f,
    +0.3813867f, +0.3851280f, +0.3888641f, +0.3925949f, +0.3963204f, +0.4000407f,
    +0.4037556f, +0.4074652f, +0.4111694f, +0.4148682f, +0.4185617f, +0.4222498f,
    +0.4259324f, +0.4296096f, +0.4332813f, +0.4369476f, +0.4406083f, +0.4442636f,
    +0.4479133f, +0.4515574f, +0.4551960f, +0.4588289f, +0.4624562f, +0.4660779f,
    +0.4696940f, +0.4733043f, +0.4769090f, +0.4805079f, +0.4841011f, +0.4876885f,
    +0.4912701f, +0.4948459f, +0.4984159f, +0.5019801f, +0.5055383f, +0.5090907f,
    +0.5126371f, +0.5161776f, +0.5197121f, +0.5232407f, +0.5267632f, +0.5302796f,
    +0.5337900f, +0.5372944f, +0.5407926f, +0.5442846f, +0.5477705f, +0.5512502f,
    +0.5547237f, +0.5581910f, +0.5616520f, +0.5651067f, +0.5685550f, +0.5719971f,
    +0.5754327f, +0.5788619f, +0.5822847f, +0.5857011f, +0.5891110f, +0.5925143f,
    +0.5959111f, +0.5993013f, +0.6026849f, +0.6060619f, +0.6094322f, +0.6127958f,
    +0.6161527f, +0.6195028f, +0.6228461f, +0.6261826f, +0.6295123f, +0.6328350f,
    +0.6361509f, +0.6394597f, +0.6427616f, +0.6460564f, +0.6493442f, +0.6526249f,
    +0.6558985f, +0.6591648f, +0.6624240f, +0.6656759f, +0.6689206f, +0.6721579f,
    +0.6753879f, +0.6786104f, +0.6818255f, +0.6850332f, +0.6882333f, +0.6914259f,
    +0.6946108f, +0.6977881f, +0.7009577f, +0.7041196f, +0.7072737f, +0.7104200f,
    +0.7135584f, +0.7166889f, +0.7198115f, +0.7229260f, +0.7260324f, +0.7291308f,
    +0.7322210f, +0.7353030f, +0.7383767f, +0.7414421f, +0.7444992f, +0.7475478f,
    +0.7505880f, +0.7536197f, +0.7566427f, +0.7596571f, +0.7626628f, +0.7656598f,
    +0.7686479f, +0.7716272f, +0.7745975f, +0.7775588f, +0.7805111f, +0.7834542f,
    +0.7863881f, +0.7893127f, +0.7922280f, +0.7951339f, +0.7980303f, +0.8009171f,
    +0.8037943f, +0.8066619f, +0.8095196f, +0.8123675f, +0.8152054f, +0.8180333f,
    +0.8208511f, +0.8236587f, +0.8264561f, +0.8292430f, +0.8320195f, +0.8347855f,
    +0.8375408f, +0.8402854f, +0.8430191f, +0.8457419f, +0.8484537f, +0.8511542f,
    +0.8538436f, +0.8565215f, +0.8591880f, +0.8618429f, +0.8644860f, +0.8671173f,
    +0.8697367f, +0.8723439f, +0.8749389f, +0.8775215f, +0.8800917f, +0.8826492f,
    +0.8851938f, +0.8877256f, +0.8902442f, +0.8927495f, +0.8952415f, +0.8977198f,
    +0.9001843f, +0.9026349f, +0.9050713f, +0.9074934f, +0.9099009f, +0.9122937f,
    +0.9146715f, +0.9170341f, +0.9193812f, +0.9217128f, +0.9240283f, +0.9263278f,
    +0.9286107f, +0.9308770f, +0.9331262f, +0.9353581f, +0.9375724f, +0.9397686f,
    +0.9419466f, +0.9441058f, +0.9462460f, +0.9483667f, +0.9504675f, +0.9525479f,
    +0.9546074f, +0.9566456f, +0.9586620f, +0.9606558f, +0.9626267f, +0.9645738f,
    +0.9664965f, +0.9683941f, +0.9702657f, +0.9721106f, +0.9739277f, +0.9757160f,
    +0.9774744f, +0.9792016f, +0.9808964f, +0.9825571f, +0.9841821f, +0.9857695f,
    +0.9873169f, +0.9888219f, +0.9902814f, +0.9916920f, +0.9930492f, +0.9943476f,
    +0.9955803f, +0.9967379f, +0.9978068f, +0.9987651f, +0.9995697f, +0.9950735f,
    +0.9707236f, +0.9468396f, +0.9234152f, +0.9004440f, +0.8779198f, +0.8558363f,
    +0.8341872f, +0.8129665f, +0.7921680f, +0.7717858f, +0.7518138f, +0.7322461f,
    +0.7130769f, +0.6943002f, +0.6759104f, +0.6579016f, +0.6402683f, +0.6230048f,
    +0.6061055f, +0.5895649f, +0.5733776f, +0.5575380f, +0.5420409f, +0.5268809f,
    +0.5120528f, +0.4975512f, +0.4833712f, +0.4695074f, +0.4559550f, +0.4427087f,
    +0.4297637f, +0.4171151f, +0.4047579f, +0.3926873f, +0.3808986f, +0.3693870f,
    +0.3581478f, +0.3471764f, +0.3364682f, +0.3260187f, +0.3158233f, +0.3058777f,
    +0.2961774f, +0.2867181f, +0.2774954f, +0.2685051f, +0.2597430f, +0.2512049f,
    +0.2428868f, +0.2347844f, +0.2268939f, +0.2192111f, +0.2117323f, +0.2044534f,
    +0.1973706f, +0.1904802f, +0.1837783f, +0.1772613f, +0.1709255f, +0.1647672f,
    +0.1587829f, +0.1529690f, +0.1473220f, +0.1418385f, +0.1365151f, +0.1313485f,
    +0.1263352f, +0.1214720f, +0.1167556f, +0.1121830f, +0.1077508f, +0.1034561f,
    +0.0992957f, +0.0952666f, +0.0913658f, +0.0875904f, +0.0839374f, +0.0804041f,
    +0.0769875f, +0.0736850f, +0.0704937f, +0.0674109f, +0.0644340f, +0.0615604f,
    +0.0587875f, +0.0561127f, +0.0535336f, +0.0510476f, +0.0486523f, +0.0463454f,
    +0.0441244f, +0.0419871f, +0.0399313f, +0.0379546f, +0.0360548f, +0.0342299f,
    +0.0324776f, +0.0307959f, +0.0291827f, +0.0276360f, +0.0261538f, +0.0247342f,
    +0.0233753f, +0.0220752f, +0.0208320f, +0.0196440f, +0.0185093f, +0.0174263f,
    +0.0163932f, +0.0154084f, +0.0144703f, +0.0135771f, +0.0127275f, +0.0119198f,
    +0.0111525f, +0.0104242f, +0.0097335f, +0.0090789f, +0.0084590f, +0.0078726f,
    +0.0073183f, +0.0067948f, +0.0063010f, +0.0058355f, +0.0053972f, +0.0049849f,
    +0.0045976f, +0.0042341f, +0.0038934f, +0.0035743f, +0.0032760f, +0.0029974f,
    +0.0027376f, +0.0024957f, +0.0022707f, +0.0020618f, +0.0018682f, +0.0016890f,
    +0.0015235f, +0.0013709f, +0.0012305f, +0.0011015f, +0.0009833f, +0.0008751f,
    +0.0007765f, +0.0006868f, +0.0006053f, +0.0005315f, +0.0004650f, +0.0004051f,
    +0.0003514f, +0.0003034f, +0.0002606f, +0.0002227f, +0.0001892f, +0.0001598f,
    +0.0001341f, +0.0001117f, +0.0000923f, +0.0000757f, +0.0000615f, +0.0000494f,
    +0.0000393f, +0.0000309f, +0.0000239f, +0.0000182f, +0.0000137f, +0.0000101f,
    +0.0000072f, +0.0000051f, +0.0000034f, +0.0000023f, +0.0000014f, +0.0000008f,
    +0.0000005f, +0.0000002f, +0.0000001f, +0.0000000f, +0.0000000f, +0.0000000f,
    +0.0000000f, +0.0000000f, -0.0034749f, -0.0074968f, -0.0115187f, -0.0155405f,
    -0.0195624f, -0.0235843f, -0.0276062f, -0.0316281f, -0.0356499f, -0.0396718f,
    -0.0399624f, -0.0397628f, -0.0393230f, -0.0385857f, -0.0375036f, -0.0360348f,
    -0.0341417f, -0.0317899f, -0.0289472f, -0.0255835f, -0.0216704f, -0.0171809f,
    -0.0120889f, -0.0063699f
};

// Helper: lookup from real glottal FLOW table with linear interpolation (wrap-safe)
static inline double lookupRealGlottal(double phase) {
    phase = phase - floor(phase);
    double idx = phase * REAL_GLOTTAL_LEN;
    int i0 = (int)idx;
    double frac = idx - i0;
    int i1 = (i0 + 1) % REAL_GLOTTAL_LEN;
...
public:
    ...
    double getNext(const speechPlayer_frame_t* frame, const speechPlayer_frameEx_t* frameEx) {
        ...
        if(glottisOpen) {
            ...
            double flowLF;
            if (useRealGlottal) {
                // Use clean mathematical glottal pulse with announcer timing
                // The table is normalized 0-1, lookup by phase
                flowLF = lookupRealGlottal(phase);
                // NOTE: We do NOT use the table dFlow - compute it from flow instead
                // This avoids any phase/scaling mismatches between flow and dFlow tables
            } else {
        ...
        // Compute derivative mathematically from flow (always, for both modes)
        // This ensures flow and dFlow are always perfectly synchronized
